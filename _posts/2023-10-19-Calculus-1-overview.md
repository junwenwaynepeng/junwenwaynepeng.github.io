...
flowchart LR;
    ...
    Diff[<a herf='../books/calculus/3-definition-of-derivatives'>Definition of derivative</a>];
    BasicFunction[<a herf='../books/calculus/3-1-how-to-do-derivatives#derivatives-of-basic-functions'>Derivative of basic functions</a>];
    BasicRules[<a herf='../books/calculus/3-1-how-to-do-derivatives#differential-rules'>Differentiation v.s. operation of functions</a>];
    ImplicitDiff[<a herf='../books/calculus/3-1-how-to-do-derivatives#implicit-differentiation'>Implicit Differentiation</a>];
    DiffInverse[<a herf='../books/calculus/3-1-how-to-do-derivatives#derivatives-of-inverse-functions'>Derivatives of inverse functions</a>];
    LogDiff[<a herf='../books/calculus/3-1-how-to-do-derivatives#logarithmetic-differentiation'>Logarithmetic Differentiation</a>];
