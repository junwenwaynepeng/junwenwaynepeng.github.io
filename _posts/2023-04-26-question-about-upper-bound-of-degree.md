...
We want to find a positive integer $B$ such that if $(x_1,x_2,\ldots, x_r)\mathbb{F}_{q}(T)\times\pi^{n-1}\mathbb{F}_{q}(T)\times\cdots\times\pi^{n-1}\mathbb{F}_{q}(T)$ is a solution of
