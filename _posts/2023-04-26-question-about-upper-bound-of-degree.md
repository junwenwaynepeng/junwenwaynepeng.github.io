...
We want to find an positive integer $B$ such that if $(x_1, x_2,\ldots, x_r)\mathbb{F}_{q^r}(T)\times\pi^{n-1}\mathbb{F}_{q^r}(T)\times\cdots\times\pi^{n-1}\mathbb{F}_{q^r}(T)$ is a solution of
